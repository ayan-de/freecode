...
2. The baseline (do NOT modify) is in
   /home/ayan-de/Projects/freecode/bench/jcode-bench/tasks/float-print/baseline.rs.
3. The candidate (you edit ONLY this) is in
   /home/ayan-de/Projects/freecode/bench/jcode-bench/tasks/float-print/candidate.rs.
...
8. When done, save the final candidate.rs to
   /home/ayan-de/Projects/freecode/bench/jcode-bench/tasks/float-print/candidate.rs and write a one-paragraph summary
   (technique used, expected score) to
   /home/ayan-de/Projects/freecode/bench/jcode-bench/tasks/float-print/SUMMARY.md.
