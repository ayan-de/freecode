...
const FLOW_STEPS = [
  {
    ...
    details: [
      "Send prompt + file tree to LLM",
      "LLM returns list of needed files",
      "CLI reads only those files",
    ],
  },
  {
    id: "phase2",
    ...
    details: [
      "Send files + prompt to LLM",
      "LLM returns structured response",
      "Parser extracts code changes",
    ],
  },
  {
    id: "phase3",
    ...
    details: [
      ...
      "Applier writes changes to filesystem",
    ],
  },
];
          ...
          <BoundaryDiagram
            layers={[
              ...
              },
              {
                ...
                components: [
                  "Send file tree only",
                  "LLM requests specific files",
                  "Read only needed files",
                  "Full context with less tokens",
                ],
                color: "rgba(34, 211, 238, 0.4)",
              },
            ]}
