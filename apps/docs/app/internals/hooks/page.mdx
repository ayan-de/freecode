...
```mermaid
graph TD
    A["agent loop / compaction / agent tool<br/>&quot;something is happening&quot;"] --> B
    B["runtime.ts — HookRuntime facade<br/>&quot;who do I call for this event?&quot;"] --> C
    C["PreToolUse.ts, TurnEnd.ts, ... (14 files)<br/>&quot;what does THIS event mean?&quot;"] --> D["registry.ts<br/>&quot;which hooks match?&quot;"]
    C --> E["executors/<br/>&quot;how do I run one?&quot;"]
```
