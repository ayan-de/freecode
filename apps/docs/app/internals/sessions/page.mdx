...
1. **Seven of the nineteen event types have no emitter.** `turn.aborted`,
   ...
   turns, tool calls, denials, model calls, compactions, and blocked hooks, and is
   silent about sub-agents, skills, aborts, and overflows. The recorder methods exist;
