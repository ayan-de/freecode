  ...
  return (
    ...
    >
      ...
      <g transform="translate(230, 468)">
        ...
        />
        <path
          d="M 12 15 H 43 M 12 25 H 43 M 12 35 H 30 M 12 45 H 25"
          stroke="rgba(16,185,129,0.5)"
          strokeWidth="2.5"
        />
        <text x="27.5" y="52" className={styles.docLabel} textAnchor="middle">
          AGENTS.md
        </text>
      </g>
      ...
      <g transform="translate(300, 468)">
        ...
        />
        <path
          d="M 28 8 L 18 32 L 28 32 L 24 52 L 40 24 L 28 24 Z"
          fill="#10b981"
        />
        <text x="27.5" y="52" className={styles.docLabel} textAnchor="middle">
          Skills
