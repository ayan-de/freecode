  ...
  return (
    ...
    >
      ...
      <g transform="translate(480, 290)" className={styles.gearGroup}>
        ...
        />
        <path
          d="M 0,-30 L 0,-25 M 0,30 L 0,25 M -30,0 L -25,0 M 30,0 L 25,0 M -21,-21 L -17,-17 M 21,21 L 17,17 M -21,21 L -17,17 M 21,-21 L 17,-17"
          stroke="#f97316"
          strokeWidth="3"
        />
      ...
      <text
        x="480"
        y="367"
        className={styles.agentLoopLabel}
        textAnchor="middle"
      >
        Reasoning Loop
      </text>
